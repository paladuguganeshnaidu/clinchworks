// Auth and profile flow manager for login/register/profile pages.
...
// Input sanitizers are centralized to keep client-side validation consistent.
...
const initAuth = () => {
    // Resolve page-specific elements only once and branch behavior by page context.
    const forms = {
